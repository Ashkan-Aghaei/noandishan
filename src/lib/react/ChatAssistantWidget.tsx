...
return {
  ...
  const MAX_ATTACH_CHARS = 12000; // در صورت نیاز کم/زیاد کن
  ...
  // 2) ضمیمه‌های متنی (txt/csv/json/md/pdf که از قبل متن‌شان را استخراج می‌کنیم)
  ...
  // 3) ضمیمه‌های تصویری (از dataURL یا هر URL)
